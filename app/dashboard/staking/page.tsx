        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              <div
                key={plan._id}
                className="bg-slate-800/50 border border-slate-700 rounded-3xl p-8 relative overflow-hidden group hover:border-blue-500/50 transition-all hover:shadow-2xl hover:shadow-blue-500/10"
              >
                {/* APR Badge */}
...
function StatCard({ icon, label, value, subtext }: any) {
  return (
    <div className="bg-slate-800/40 p-8 rounded-[2rem] border border-slate-700/50 flex items-center gap-6">

  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-0 md:p-10 overflow-x-hidden">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* HEADER */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900/50 p-6 md:p-8 rounded-[2rem] border border-slate-800">
          <div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-950/50 border-b border-slate-800 text-[11px] uppercase tracking-[0.2em] font-black text-slate-500">
                  <th className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">Staked Asset</th>
                  <th className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">Amount</th>
                  <th className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">Reward (APR)</th>
                  <th className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">Unlock Date</th>
                  <th className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">Status</th>
                  <th className="px-4 md:px-8 py-4 md:py-6 text-right whitespace-nowrap">Management</th>
                </tr>
              </thead>
                        ...
                        <td className="px-4 md:px-8 py-4 md:py-6 whitespace-nowrap">
                          <div className="flex justify-end gap-3">
                            ...
                            <button
                              ...
                              className={`px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest flex items-center gap-2 transition-all shadow-lg ${isMatured

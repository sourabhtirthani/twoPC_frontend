...
export default function ReferralEarningsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-0 md:p-10">
                ...
                {loading ? (
                  ...
                  earnings.map((record) => (
                    <tr key={record._id} className="hover:bg-blue-50/30 transition-colors group">
                      ...
                      <td className="px-8 py-6">
                        <span className={`px-3 py-1 rounded-full text-[10px] font-black tracking-tighter border ${record.level === 1 ? 'bg-blue-50 text-blue-600 border-blue-100' :

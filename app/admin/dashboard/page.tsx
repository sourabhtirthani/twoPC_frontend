...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-0 md:p-10 space-y-6 md:space-y-8">

      {/* HEADER SECTION */}
      <div className="flex flex-col lg:flex-row md:items-center justify-between gap-6 bg-white p-4 md:p-8 rounded-3xl md:rounded-[2.5rem] border border-slate-200 shadow-sm">
